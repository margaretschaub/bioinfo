...
I would separate the challenges of cross dataset survey work into 2 broad categories:
...
- Heterogeneous Data Integration: Datasets with varying numbers of variables, mismatched scaling, and different generation platforms require sophisticated statistical models.
...
The study addresses challenges unique to RNA-seq data, such as the discrete and highly heterogeneous nature of the data. To overcome this, the authors propose filtering weakly expressed genes and identify post-hoc removal of genes exhibiting conflicting differential expression. 
